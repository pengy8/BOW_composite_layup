...
#    q0 = np.array([0.77350981,  0.26461169, -1.40589339,  2.07777698,  0.33594179, -0.49547579, -0.03298059]) 
    q0 = np.array([0.38963112,  0.42491268, -1.41816524,  2.02101969,  0.45175734, -0.85826225,  0.19328158]) 
...
#                print ('Claps Norm:', claps_norm)           
        ...
        sio.savemat('Data20200801.mat', {'t_all':t_all,'VT_all':VT_all,'Xk_all':Xk_all,'Z_all':Z_all, 'wr_all':wr_all, 'q_all':q_all,'pose_all':pose_all})    
